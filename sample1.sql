...
,r7_r28_net_apointments_totals_city as 
...
inner join r28_net_slot_totals b on 
	(a.doctor_type = b.doctor_type and a.reporting_city = b.reporting_city))
...
,doctor_bookings_share_offering_city as 
...
left join r7_net_apointments_p b on 
	(a.doctor_id = b.doctor_id and a.doctor_type = b.doctor_type and a.reporting_city = b.reporting_city)
left join r7_r28_net_apointments_totals_city c on 
	(a.doctor_type = c.doctor_type and a.reporting_city = c.reporting_city))

select * from doctor_bookings_share_offering_city